class V1::Entities::AcademicProgram < Grape::Entity
  ...
  expose :created_at, documentation: { type: "DateTime", desc: "Academic Program Created At" }
  expose :updated_at, documentation: { type: "DateTime", desc: "Academic Program Updated At" }
end
